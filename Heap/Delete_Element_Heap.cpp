//delete the top most element from heap
/*
	Deletion is there for the first element of array of heap only
	We replace the last node value with the first node and return the last node
	value and delete the last element by decreasing the count size by 1.
	After doing that we percolate down once from the root
*/
